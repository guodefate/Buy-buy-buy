            ...
            <div class="form-box accept-box form-box1">
                <dl class="head form-group">
                    <dd>
                        ...
                        <router-link v-show="orderinfo.status==1" :to="'/payMoney/'+orderinfo.id" class="btn-pay">去付款</router-link>
                        <a v-show="orderinfo.status==2||orderinfo.status==3" @click="Receiving" class="btn-pay">确认收货</a>
